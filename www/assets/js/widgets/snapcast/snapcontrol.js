...
function show() {
    ...
    for (let group of server.groups) {
        ...
        if (clientCount > 1) {
            ...
            content += "<a href=\"javascript:setMuteGroup('" + group.id + "'," + !muted + ");\"><i class='fa fa-speaker mute-button'></i></a>";
        ...
        for (let client of group.clients) {
            ...
            // Populate client div
            content += "<a href=\"javascript:setVolume('" + client.id + "'," + !muted + ");\"><i class='fa fa-speaker mute-button'></i></a>";

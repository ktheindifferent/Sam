...
impl Setting {
    ...
    pub fn save(&self) -> Result<&Self> {
        ...
        pg_query
            .queries
            .push(crate::memory::PGCol::String(self.key.clone()));
    ...
    pub fn destroy(oid: String) -> Result<bool> {
        crate::memory::Config::destroy_row(oid, "config_settings".to_string())
    }
    ...
    pub async fn destroy_async(oid: String) -> Result<bool> {
        crate::memory::Config::destroy_row_async(oid, "config_settings".to_string()).await
    }
}

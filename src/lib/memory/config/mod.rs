...
pub struct Config {
    pub postgres: crate::memory::PostgresServer,
...
impl Config {
    ...
    pub async fn init(&self) {
        ...
        thread_manager::spawn("http-server", move |shutdown_signal, _health_rx| {
            ...
            rouille::start_server("0.0.0.0:8000".to_string().as_str(), move |request| {
                match crate::http::handle(request) {
                    Ok(request) => request,
                    Err(err) => {
                        log::error!("HTTP_ERROR: {}", err);
                        // Report HTTP errors to Sentry
                        crate::monitoring::report_service_error("http_server", &err, None);
                        Response::empty_404()
                    }
                }
            });
    ...
    pub async fn connect_pool(&self) -> Result<deadpool_postgres::Client> {
        ...
        let client = pool.get().await.map_err(crate::memory::Error::from)?;
        Ok(client)
    }
    ...
    pub async fn build_tables(&self) -> Result<()> {
        ...
        let tables = [
            (
                crate::memory::cache::WikipediaSummary::sql_table_name(),
                crate::memory::cache::WikipediaSummary::sql_build_statement(),
                crate::memory::cache::WikipediaSummary::migrations(),
            ),
            (
                crate::memory::Human::sql_table_name(),
                crate::memory::Human::sql_build_statement(),
                crate::memory::Human::migrations(),
            ),
            (
                crate::memory::human::FaceEncoding::sql_table_name(),
                crate::memory::human::FaceEncoding::sql_build_statement(),
                crate::memory::human::FaceEncoding::migrations(),
            ),
            (
                crate::memory::location::Location::sql_table_name(),
                crate::memory::location::Location::sql_build_statement(),
                crate::memory::location::Location::migrations(),
            ),
            (
                crate::memory::room::Room::sql_table_name(),
                crate::memory::room::Room::sql_build_statement(),
                crate::memory::room::Room::migrations(),
            ),
            (
                crate::memory::config::Service::sql_table_name(),
                crate::memory::config::Service::sql_build_statement(),
                crate::memory::config::Service::migrations(),
            ),
            (
                crate::memory::Thing::sql_table_name(),
                crate::memory::Thing::sql_build_statement(),
                crate::memory::Thing::migrations(),
            ),
            (
                crate::memory::Observation::sql_table_name(),
                crate::memory::Observation::sql_build_statement(),
                crate::memory::Observation::migrations(),
            ),
            (
                crate::memory::config::Setting::sql_table_name(),
                crate::memory::config::Setting::sql_build_statement(),
                crate::memory::config::Setting::migrations(),
            ),
            (
                crate::memory::cache::WebSessions::sql_table_name(),
                crate::memory::cache::WebSessions::sql_build_statement(),
                crate::memory::cache::WebSessions::migrations(),
            ),
            (
                crate::memory::config::FileStorageLocation::sql_table_name(),
                crate::memory::config::FileStorageLocation::sql_build_statement(),
                crate::memory::config::FileStorageLocation::migrations(),
            ),
            (
                crate::memory::storage::File::sql_table_name(),
                crate::memory::storage::File::sql_build_statement(),
                crate::memory::storage::File::migrations(),
            ),
            (
                crate::memory::human::Notification::sql_table_name(),
                crate::memory::human::Notification::sql_build_statement(),
                crate::memory::human::Notification::migrations(),
            ),
            (
                crate::services::crawler::CrawlJob::sql_table_name(),
                crate::services::crawler::CrawlJob::sql_build_statement(),
                crate::services::crawler::CrawlJob::migrations(),
            ),
            (
                crate::services::crawler::CrawledPage::sql_table_name(),
                crate::services::crawler::CrawledPage::sql_build_statement(),
                crate::services::crawler::CrawledPage::migrations(),
            ),
            (
                crate::services::crawler::CrawledContent::sql_table_name(),
                crate::services::crawler::CrawledContent::sql_build_statement(),
                crate::services::crawler::CrawledContent::migrations(),
            ),
            (
                crate::services::crawler::CrawlRejected::sql_table_name(),
                crate::services::crawler::CrawlRejected::sql_build_statement(),
                crate::services::crawler::CrawlRejected::migrations(),
            ),
            (
                crate::memory::cache::WebCrawl::sql_table_name(),
                crate::memory::cache::WebCrawl::sql_build_statement(),
                crate::memory::cache::WebCrawl::migrations(),
            ),
            (
                crate::memory::cache::WebCrawlExtResult::sql_table_name(),
                crate::memory::cache::WebCrawlExtResult::sql_build_statement(),
                crate::memory::cache::WebCrawlExtResult::migrations(),
            ),
        ];
        ...
        for (table_name, build_statement, migrations) in tables {
            ...
            if table_name == crate::services::crawler::CrawlJob::sql_table_name() {
                for idx_sql in crate::services::crawler::CrawlJob::sql_indexes() {
            ...
            if table_name == crate::services::crawler::CrawledPage::sql_table_name() {
                for idx_sql in crate::services::crawler::CrawledPage::sql_indexes() {
                    match current_client.batch_execute(idx_sql).await {
                        Ok(_) => {
                            log::info!("POSTGRES: Created index for '{}': {}", table_name, idx_sql)
                        }
            ...
            if table_name == crate::services::crawler::CrawledContent::sql_table_name() {
                for idx_sql in crate::services::crawler::CrawledContent::sql_indexes() {
                    match current_client.batch_execute(idx_sql).await {
                        Ok(_) => {
                            log::info!("POSTGRES: Created index for '{}': {}", table_name, idx_sql)
                        }
            ...
            if table_name == crate::services::crawler::CrawlRejected::sql_table_name() {
                for idx_sql in crate::services::crawler::CrawlRejected::sql_indexes() {
                    match current_client.batch_execute(idx_sql).await {
                        Ok(_) => {
                            log::info!("POSTGRES: Created index for '{}': {}", table_name, idx_sql)
                        }
    ...
    fn serialize_row(
        ...
        match table_name {
            t if t == crate::memory::cache::WikipediaSummary::sql_table_name() => {
                push_json!(crate::memory::cache::WikipediaSummary, from_row);
            }
            t if t == crate::memory::Human::sql_table_name() => {
                push_json!(crate::memory::Human, from_row);
            }
            t if t == crate::memory::human::FaceEncoding::sql_table_name() => {
                push_json!(crate::memory::human::FaceEncoding, from_row);
            }
            t if t == crate::memory::Location::sql_table_name() => {
                push_json!(crate::memory::Location, from_row);
            }
            t if t == crate::memory::human::Notification::sql_table_name() => {
                push_json!(crate::memory::human::Notification, from_row);
            }
            t if t == crate::memory::Room::sql_table_name() => {
                push_json!(crate::memory::Room, from_row);
            }
            t if t == crate::memory::config::Service::sql_table_name() => {
                push_json!(crate::memory::config::Service, from_row);
            }
            t if t == crate::memory::Thing::sql_table_name() => {
                push_json!(crate::memory::Thing, from_row);
            }
            t if t == crate::memory::Observation::sql_table_name() => {
                if columns.is_none() {
                    push_json!(crate::memory::Observation, from_row);
                } else {
                    push_json!(crate::memory::Observation, from_row_lite);
                }
            }
            t if t == crate::memory::config::Setting::sql_table_name() => {
                push_json!(crate::memory::config::Setting, from_row);
            }
            t if t == crate::memory::cache::WebSessions::sql_table_name() => {
                push_json!(crate::memory::cache::WebSessions, from_row);
            }
            t if t == crate::memory::config::FileStorageLocation::sql_table_name() => {
                push_json!(crate::memory::config::FileStorageLocation, from_row);
            }
            t if t == crate::memory::storage::File::sql_table_name() => {
                if columns.is_none() {
                    push_json!(crate::memory::storage::File, from_row);
                } else {
                    push_json!(crate::memory::storage::File, from_row_lite);
                }
            }
            t if t == crate::services::crawler::CrawlJob::sql_table_name() => {
                push_json!(crate::services::crawler::CrawlJob, from_row);
            }
            t if t == crate::services::crawler::CrawledPage::sql_table_name() => {
                push_json!(crate::services::crawler::CrawledPage, from_row);
            }
            t if t == crate::memory::cache::WebCrawl::sql_table_name() => {
                push_json!(crate::memory::cache::WebCrawl, from_row);
            }
            t if t == crate::memory::cache::WebCrawlExtResult::sql_table_name() => {
                push_json!(crate::memory::cache::WebCrawlExtResult, from_row);
            }
            _ => {}
        }
        Ok(())
    ...
    async fn serialize_row_async(
        ...
        match table_name {
            t if t == crate::memory::cache::WikipediaSummary::sql_table_name() => {
                push_json_async!(crate::memory::cache::WikipediaSummary, from_row_async);
            }
            t if t == crate::memory::Human::sql_table_name() => {
                push_json_async!(crate::memory::Human, from_row_async);
            }
            t if t == crate::memory::human::FaceEncoding::sql_table_name() => {
                push_json_async!(crate::memory::human::FaceEncoding, from_row_async);
            }
            t if t == crate::memory::Location::sql_table_name() => {
                push_json_async!(crate::memory::Location, from_row_async);
            }
            t if t == crate::memory::human::Notification::sql_table_name() => {
                push_json_async!(crate::memory::human::Notification, from_row_async);
            }
            t if t == crate::memory::Room::sql_table_name() => {
                push_json_async!(crate::memory::Room, from_row_async);
            }
            t if t == crate::memory::config::Service::sql_table_name() => {
                push_json_async!(crate::memory::config::Service, from_row_async);
            }
            t if t == crate::memory::Thing::sql_table_name() => {
                push_json_async!(crate::memory::Thing, from_row_async);
            }
            t if t == crate::memory::Observation::sql_table_name() => {
                if columns.is_none() {
                    push_json_async!(crate::memory::Observation, from_row_async);
                } else {
                    push_json_async!(crate::memory::Observation, from_row_lite_async);
                }
            }
            t if t == crate::memory::config::Setting::sql_table_name() => {
                push_json_async!(crate::memory::config::Setting, from_row_async);
            }
            t if t == crate::memory::cache::WebSessions::sql_table_name() => {
            ...
            t if t == crate::memory::storage::File::sql_table_name() => {
                if columns.is_none() {
                    push_json_async!(crate::memory::storage::File, from_row_async);
                } else {
                    push_json_async!(crate::memory::storage::File, from_row_lite_async);
                }
            }
            t if t == crate::services::crawler::CrawlJob::sql_table_name() => {
                push_json_async!(crate::services::crawler::CrawlJob, from_row_async);
            }
            t if t == crate::services::crawler::CrawledPage::sql_table_name() => {
                push_json_async!(crate::services::crawler::CrawledPage, from_row_async);
            }
            t if t == crate::memory::cache::WebCrawl::sql_table_name() => {
                push_json_async!(crate::memory::cache::WebCrawl, from_row_async);
            }
            t if t == crate::memory::cache::WebCrawlExtResult::sql_table_name() => {
                push_json_async!(crate::memory::cache::WebCrawlExtResult, from_row_async);
            }
            _ => {}
        }
        Ok(())

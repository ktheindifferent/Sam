...
pub fn get(text: String) -> Result<Vec<u8>, crate::services::Error> {
    ensure_tts_tmp_dir();
...
pub fn fetch_online(text: String) -> Result<Vec<u8>, crate::services::Error> {
...
pub fn fetch_local(text: String) -> Result<Vec<u8>, crate::services::Error> {
    let client = reqwest::blocking::Client::new();
    let bytes = client
        .get(format!(

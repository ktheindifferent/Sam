                    ...
                    move |request| {
                        ...
                        if request.url().contains("/scenes") {
                            ...
                            let scenes = json!({
                                "scenes": [
                                    ...
                                    {"id": "meditation", "name": "Meditation", "brightness": 35, "kelvin": 2400},
                                    {"id": "gaming", "name": "Gaming", "brightness": 70, "kelvin": 5500},
                                    {"id": "movie", "name": "Movie", "brightness": 30, "kelvin": 2200},
                                    {"id": "morning", "name": "Morning", "brightness": 50, "kelvin": 5500},
                                    {"id": "goodnight", "name": "Goodnight", "brightness": 15, "kelvin": 2200},
                                    {"id": "rainbow", "name": "Rainbow", "brightness": 100, "kelvin": 4000},
                                    {"id": "fireplace", "name": "Fireplace", "brightness": 60, "kelvin": 2000},
                                    {"id": "ice", "name": "Ice", "brightness": 75, "kelvin": 8000},
                                    {"id": "aurora", "name": "Aurora", "brightness": 70, "kelvin": 6000},
                                    {"id": "nebula", "name": "Nebula", "brightness": 50, "kelvin": 4500},
                                    {"id": "thunder", "name": "Thunder", "brightness": 80, "kelvin": 5000},
                                    {"id": "crystal", "name": "Crystal", "brightness": 65, "kelvin": 7500},
                                    {"id": "cyberpunk", "name": "Cyberpunk", "brightness": 70, "kelvin": 4500},
                                    {"id": "vaporwave", "name": "Vaporwave", "brightness": 65, "kelvin": 4000},
                                    {"id": "halloween", "name": "Halloween", "brightness": 65, "kelvin": 2800},
                                    {"id": "christmas", "name": "Christmas", "brightness": 75, "kelvin": 3500},
                                    {"id": "beach", "name": "Beach", "brightness": 70, "kelvin": 5000},
                                    {"id": "forest", "name": "Forest", "brightness": 65, "kelvin": 4200},
                                    {"id": "yoga", "name": "Yoga", "brightness": 45, "kelvin": 3800},
                                    {"id": "cooking", "name": "Cooking", "brightness": 90, "kelvin": 4500},
                                    {"id": "creative", "name": "Creative", "brightness": 65, "kelvin": 5000},
                                    {"id": "dinner", "name": "Dinner", "brightness": 55, "kelvin": 3000},
                                    {"id": "spa", "name": "Spa", "brightness": 40, "kelvin": 3500},
                                    {"id": "festival", "name": "Festival", "brightness": 85, "kelvin": 4200},
                                    {"id": "spring", "name": "Spring", "brightness": 75, "kelvin": 4500},
                                    {"id": "autumn", "name": "Autumn", "brightness": 65, "kelvin": 2800},
                                    {"id": "winter", "name": "Winter", "brightness": 70, "kelvin": 6500},
                                    {"id": "summer", "name": "Summer", "brightness": 100, "kelvin": 5500},
                                    {"id": "concentrate", "name": "Concentrate", "brightness": 85, "kelvin": 5200},
                                    {"id": "chromatic", "name": "Chromatic", "brightness": 75, "kelvin": 4800},
                                    {"id": "magnify", "name": "Magnify", "brightness": 70, "kelvin": 4600},
                                    {"id": "contemplation", "name": "Contemplation", "brightness": 50, "kelvin": 3800},
                                    {"id": "faded", "name": "Faded", "brightness": 60, "kelvin": 5000}
                                ]
                            });
                        ...
                        if request.url().contains("/apply_scene") {
                            ...
                            let scene_settings = match input.scene.as_str() {
                                ...
                                "chromatic" => (75, 4800),
                                "magnify" => (70, 4600),
                                "contemplation" => (50, 3800),
                                "faded" => (60, 5000),
                                "lagoon" => (55, 4200),
                                "cotton_candy" => (70, 3500),
                                "spring_blossom" => (60, 3800),
                                "punchbowl" => (85, 4000),
                                "smashing" => (90, 4500),
                                "glitter" => (80, 5000),
                                "golden_hour" => (45, 3200),
                                ...
                                "chill" => (50, 3500),
                                "adventure" => (75, 4800),
                                "bioluminescent" => (55, 5500),
                                "northern_lights" => (60, 5000),
                                "desert_dawn" => (50, 3600),
                                "forest_mist" => (45, 4500),
                                "volcanic" => (70, 2800),
                                "underwater" => (55, 5200),
                                "space_station" => (75, 6500),
                                "wizard_tower" => (50, 3000),
                                "dragon_fire" => (80, 2500),
                                "fairy_grove" => (60, 4200),
                                "haunted" => (40, 3500),
                                "santas_workshop" => (70, 3000),
                                "new_year" => (85, 4500),
                                "valentines" => (55, 3200),
                                "thanksgiving" => (50, 3000),
                                "easter" => (70, 4500),
                                "st_patricks" => (65, 4000),
                                "independence_day" => (80, 5000),
                                "galaxy" => (60, 5000),
                                "pulsar" => (90, 8000),
                                "comet" => (75, 5500),
                                "meteor" => (85, 6000),

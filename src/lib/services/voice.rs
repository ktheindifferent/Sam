...
impl VoiceAssistant {
    ...
    pub fn start_listening(&self) -> Result<(), crate::services::Error> {
    ...
    pub fn stop_listening(&self) -> Result<(), crate::services::Error> {
        let mut listening = self.is_listening.lock().map_err(|e| {
            crate::services::Error::from(format!("Failed to lock listening state: {}", e))
        })?;
    ...
    pub fn generate_response(&self, text: &str) -> Result<VoiceResponse, crate::services::Error> {
    ...
    pub fn speak(&self, text: &str) -> Result<(), crate::services::Error> {
...
impl VoiceService {
    ...
    pub fn initialize(&self, config: VoiceConfig) -> Result<(), crate::services::Error> {

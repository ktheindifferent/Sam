...
fn default_user_agent() -> String {
    "Mozilla/5.0 (compatible; SAMBot/1.0)".to_string()
}
...
fn default_js_timeout() -> Duration {
    Duration::from_secs(30)
}
...
fn default_database_url() -> String {
    std::env::var("DATABASE_URL")
        .unwrap_or_else(|_| "postgresql://sam:sam@localhost/sam".to_string())
}
...
fn default_max_pagination() -> usize {
    20
}
fn default_calendar_threshold() -> usize {
    10
}
...
impl CrawlerConfig {
    ...
    pub async fn apply(&self) -> Result<()> {
        ...
        super::rate_limiter::init_rate_limiter(
            rate_config,
            Some(self.rate_limiting.requests_per_second as u32),
        );

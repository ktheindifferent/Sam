...
pub async fn install() -> Result<()> {
    ...
    write_file(include_bytes!("../../../scripts/who.io/who2.py"), "/opt/sam/scripts/who.io/who2.py").await?;

    // Write the trained KNN model
    write_file(include_bytes!("../../../scripts/who.io/trained_knn_model.clf"), "/opt/sam/scripts/who.io/trained_knn_model.clf").await?;

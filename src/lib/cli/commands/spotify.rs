    ...
    match cmd {
        "spotify start" => {
            crate::cli::spinner::run_with_spinner(
                ...
                || async {
                    crate::services::spotify::start().await;
                    "done".to_string()
                },
            )
            .await;
        ...
        "spotify stop" => {
            crate::cli::spinner::run_with_spinner(
                ...
                || async {
                    crate::services::spotify::stop().await;
                    "done".to_string()
                },
            )
            .await;
        ...
        "spotify status" => {
            crate::cli::spinner::run_with_spinner(
                ...
                || async { crate::services::spotify::status() },
            )
            .await;
        }
        "spotify play" => {
            crate::cli::spinner::run_with_spinner(
                ...
                || async {
                    crate::services::spotify::play().await;
                    "done".to_string()
                },
            )
            .await;
        ...
        "spotify pause" => {
            crate::cli::spinner::run_with_spinner(
                ...
                || async {
                    crate::services::spotify::pause().await;
                    "done".to_string()
                },
            )
            .await;
        ...
        "spotify shuffle" => {
            crate::cli::spinner::run_with_spinner(
                ...
                || async {
                    crate::services::spotify::shuffle().await;
                    "done".to_string()
                },
            )
            .await;
